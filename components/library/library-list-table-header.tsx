...
export function LibraryListTableHeader({
 ...
 className={cn(
 "relative flex h-[50px] w-full items-center justify-center",
 column.sortable &&
...
>
 ...
 <span
 className={cn(
 "absolute left-[calc(50%+2rem)] inline-flex h-4 w-4 shrink-0 items-center justify-center transition-opacity",
 isActive(column)
 ? "opacity-90"
