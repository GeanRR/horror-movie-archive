...
export function useAddMovieFlow(open: boolean) {
 ...
 draft.subgenres = details.subgenres;
 ...
 subgenres: normalizePrimarySubgenres(selectedMovie.subgenres, {
 title: selectedMovie.displayTitle,
 originalTitle: selectedMovie.originalTitle,
 genres: selectedMovie.genres,
 overview: selectedMovie.synopsis,
 }),
